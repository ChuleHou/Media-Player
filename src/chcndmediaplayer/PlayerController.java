...
public class PlayerController extends TransferScene implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        visualizers.add(new VisualizerModel());
    ...
    @FXML
    public void handleAbout() throws Exception{
       chcndmediaplayer.About about=new About();
       about.showWindow();
